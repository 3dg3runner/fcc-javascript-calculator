...
class Calculator extends React.Component {
  ...
  updateState(info) {
    ...
    if (info.action === append) {
      ...
      else if (this.state.pastDisplay === this.state.currentInput) {
        oldDisplayUpdate = this.state.currentInput.concat(info.value);
        oldCurrentDisplay = this.state.currentInput.concat(info.value);
      }
      else {
    ...
    return(
      <div id="calculator-container">
        <div id="display-container">
          <div id="past-display">
            <h4>{this.state.pastDisplay}</h4>
          </div>
          <div id="current-display">
            <h3 id="display">{this.state.currentDisplay}</h3>
          </div>
        </div>
        <div id="buttons">
          <div id="clear" className="button" href="#" onClick={this.handleClick}>AC</div>
          <div id="divide" className="button" href="#" onClick={this.handleClick}>/</div>
          <div id="multiply" className="button" href="#" onClick={this.handleClick}>X</div>
          <div id="seven" className="button" href="#" onClick={this.handleClick}>7</div>
          <div id="eight" className="button" href="#" onClick={this.handleClick}>8</div>
          <div id="nine" className="button" href="#" onClick={this.handleClick}>9</div>
          <div id="subtract" className="button" href="#" onClick={this.handleClick}>-</div>
          <div id="four" className="button" href="#" onClick={this.handleClick}>4</div>
          <div id="five" className="button" href="#" onClick={this.handleClick}>5</div>
          <div id="six" className="button" href="#" onClick={this.handleClick}>6</div>
          <div id="add" className="button" href="#" onClick={this.handleClick}>+</div>
          <div id="one" className="button" href="#" onClick={this.handleClick}>1</div>
          <div id="two" className="button" href="#" onClick={this.handleClick}>2</div>
          <div id="three" className="button" href="#" onClick={this.handleClick}>3</div>
          <div id="zero" className="button" href="#" onClick={this.handleClick}>0</div>
          <div id="decimal" className="button" href="#" onClick={this.handleClick}>.</div>
          <div id="equals" className="button" href="#" onClick={this.handleClick}>=</div>
        </div>
      </div>
    );
  }
